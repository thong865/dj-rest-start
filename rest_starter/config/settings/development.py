"""
Django settings for rest_starter project.
...
ROOT_URLCONF = 'rest_starter.config.urls'
...
WSGI_APPLICATION = 'rest_starter.config.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'exch',#os.environ.get('DB_NAME'),
